...
public class OtlUpdateVariableImpl extends ASTWrapperPsiElement implements OtlUpdateVariable {

  public OtlUpdateVariableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OtlVisitor visitor) {
    visitor.visitUpdateVariable(this);
  }
