...
public class OtlMethodKeyImpl extends OtlNamedElementImpl implements OtlMethodKey {

  public OtlMethodKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OtlVisitor visitor) {
    visitor.visitMethodKey(this);
  }
